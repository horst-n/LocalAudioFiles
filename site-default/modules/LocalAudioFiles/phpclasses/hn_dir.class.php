...
{
	if(file_exists('C:/bin_local/PHP_includes/hn_basic.class.php')) require_once('C:/bin_local/PHP_includes/hn_basic.class.php');
...
#$d = new hn_dirbasic();
#echo $d->dir_size('F:/',TRUE);
#$d->make_ABC_dirs('C:/__test__','sub_','hex');
